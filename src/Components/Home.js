    ...
    <div className="container newFont">
      <div className="row align-items-center justify-content-center text-center">
        <div className="col-md-8" data-aos="fade-up" data-aos-delay="400">
          ...
          <p data-aos="fade-up" data-aos-delay="200"><button href="/mainDirectory" className="btn btn-info py-3 px-8 mb-5 text-white"><span style={{opactiy:'0.3'}}>Start Program </span></button></p>
        </div>
      </div>
    </div>
  </div>  
